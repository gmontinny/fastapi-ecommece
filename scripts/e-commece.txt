...
alter table if exists sales_orders drop constraint if exists fk_coupon_order ;
alter table if exists product_tags drop constraint if exists fk_products_product_tags ;
alter table if exists product_tags drop constraint if exists fk_tags_product_tags ;
alter table if exists user_roles drop constraint if exists fk_roles_user_roles ;
alter table if exists user_roles drop constraint if exists fk_users_user_roles ;
alter table if exists product_categories drop constraint if exists fk_category_products_categories ;
alter table if exists sales_orders drop constraint if exists fk_user_sales_order ;
alter table if exists sales_orders drop constraint if exists fk_session_sales_order ;
alter table if exists products drop constraint if exists fk_product_statuses_product ;
alter table if exists order_products drop constraint if exists fk_sales_orders_order_products ;
alter table if exists cc_transactions drop constraint if exists fk_sales_order_cc_transaction ;
alter table if exists product_categories drop constraint if exists fk_product_product_category ;
alter table if exists categories drop constraint if exists fk_category_parent_category ;
